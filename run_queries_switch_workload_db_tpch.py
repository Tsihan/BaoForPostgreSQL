...
USE_BAO = True
PG_CONNECTION_STR_origin = "dbname=tpch10load user=qihan host=localhost"
PG_CONNECTION_STR_second = "dbname=tpch1load user=qihan host=localhost"
...
# 在程序结束时调用
send_email("Bao Experiment", "The experiment of TPCH both switching workload and db finished!", "EMAIL")
